...
from my_app.twittermodule.tweet import Tweet

class TweetStore:

    # Redis Configuration
    redis_host = "redis-18082.c92.us-east-1-3.ec2.cloud.redislabs.com"
    redis_port = 18082
    redis_password = "I1qlzgCxP1xUxZODsrExAfgkPoiW3hqI"
